      ...
      <div className="w-[90vw] max-w-[var(--max-width)] mx-auto">
        ...
        <div className="grid gap-6 mb-12 md:grid-cols-3">
          ...
          <div className="relative group">
            <label className="absolute -top-2 left-3 bg-white px-1 text-xs font-bold text-[#c87941] uppercase tracking-wider z-10 transition-colors group-hover:text-[#ba6f3e]">{t.common.category}</label>
            <select
              value={category}
          ...
          {/* Company Filter */}
          <div className="relative group">
            <label className="absolute -top-2 left-3 bg-white px-1 text-xs font-bold text-[#c87941] uppercase tracking-wider z-10 transition-colors group-hover:text-[#ba6f3e]">{t.common.company}</label>
            <select
              value={company}
          ...
          {/* Sort Filter */}
          <div className="relative group">
            <label className="absolute -top-2 left-3 bg-white px-1 text-xs font-bold text-[#c87941] uppercase tracking-wider z-10 transition-colors group-hover:text-[#ba6f3e]">{t.common.sortBy}</label>
            <select
              value={sort}
            ...
            >
              ...
              <option value="price-lowest">{t.common.priceLowest}</option>
              <option value="price-highest">{t.common.priceHighest}</option>
              <option value="name-a">{t.common.nameA}</option>
              <option value="name-z">{t.common.nameZ}</option>
            </select>
            <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-[#c87941] group-hover:translate-y-[-10%] transition-transform duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
